defmodule StordUrlWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StordUrlWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StordUrlWeb.Gettext, "errors", msg, opts)
    end
  end
